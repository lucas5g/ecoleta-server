...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, city, uf, items, parsedItems, points, _b, _c, _i, r, _d, serializedPoints;
                ...
                switch (_e.label) {
                    ...
                    case 5:
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image: "http://192.168.0.28:8000/uploads/" + point.image });
                        });
    ...
    PointsController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, point, serializedPoints, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _a = [__assign({}, point)];
                        _b = { image: "http://192.168.0.28:8000/uploads/" + point.image };
                        return [4 /*yield*/, connection_1.default('items')
                                .join('point_items', 'items.id', '=', 'point_items.item_id')
                                .where('point_items.point_id', id)];
                    case 2:
                        serializedPoints = __assign.apply(void 0, _a.concat([(_b.items = _c.sent(), _b)]));
                        return [2 /*return*/, response.json(serializedPoints)
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        point = {
                            ...
                            name: name, email: email, whatsapp: whatsapp, latitude: latitude, longitude: longitude, city: city, uf: uf
                        };
